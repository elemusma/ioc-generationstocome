...
function generations_to_come_stylesheets() {
...
add_action('wp_enqueue_scripts', 'generations_to_come_stylesheets');
// for footer
function generations_to_come_stylesheets_footer() {
...
add_action('get_footer', 'generations_to_come_stylesheets_footer');
...
function generations_to_come_menus() {
...
add_action('after_setup_theme', 'generations_to_come_menus');
